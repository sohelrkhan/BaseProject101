...
export class CountryService {
  ...
  getAllCountries(): Observable<CountryOption[]> {
    ...
    return of(sortedCountries);
  }

  /**
   * Get countries by region (if you want to filter by region)
   */
  getCountriesByRegion(region: string): Observable<CountryOption[]> {
    // You can extend this to include region data if needed
